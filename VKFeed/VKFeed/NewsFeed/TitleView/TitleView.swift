...
class TitleView: UIView {
    ...
    private var myAvatarView: WedImageView = {
    ...
    private func makeConstraints() {
        ...
        myAvatarView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 1).isActive = true
        myAvatarView.widthAnchor.constraint(equalTo: heightAnchor, multiplier: 1).isActive = true
